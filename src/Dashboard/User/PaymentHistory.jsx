                    ...
                    payments?.length > 0 ?
                        (
                            payments?.map((payment, idx) =>
                                <div key={payment._id} className="flex flex-col w-1/2 mx-auto shadow-2xl mt-10 p-10 rounded-lg bg-emerald-950 text-gray-400">
                        ...
                        <div className="flex flex-col w-1/2 mx-auto shadow-2xl mt-10 p-10 rounded-lg bg-slate-700 text-gray-400">
