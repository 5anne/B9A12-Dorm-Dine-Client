...
const Motto = () => {
    return (
        <div className="bg-no-repeat bg-fixed bg-cover p-24 my-36 max-w-6xl mx-auto" style={{ backgroundImage: 'url(https://i.postimg.cc/qqvQQqLK/medium-shot-chef-wearing-face-mask-23-2148931867.jpg)' }}>
            <div className="bg-white bg-opacity-30 px-8 pt-4 pb-12">
                ...
                <div className="flex gap-4 items-center">
                    <img className="w-1/2 h-72" src="https://i.postimg.cc/t4c06Q9D/24550476393-c95f3280eb-c-63bc36b903832-700.jpg" alt="" />
                    <div className="w-1/2 text-black font-display">
